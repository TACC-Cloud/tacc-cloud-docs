...
htmlhelp_basename = 'TACCCloudAPIsdoc'
...
latex_documents = [
    (master_doc, 'TACCCloudAPIs.tex', 'TACC Cloud APIs Documentation',
     'TACC', 'manual'),
]
...
man_pages = [
    (master_doc, 'tacccloudapis', 'TACC Cloud APIs Documentation',
     'TACC', 1)
]
...
texinfo_documents = [
    (master_doc, 'TACCCloudAPIs', 'TACC Cloud APIs Documentation',
     'TACC', 'TACCCloudAPIs', 'One line description of project.',
     'Miscellaneous'),
]
